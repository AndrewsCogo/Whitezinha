...
define("MSSQL_Pass", "@white@"); // -- Senha do MSSQL
define("MSSQL_DB", "MuOnline"); // -- DataBase do Web Site (Padrão -> CTM_TeaM)
...
/*****************************************************************************
	...
	@ false = Não
*****************************************************************************/
define("MySQL_Security_Log", false); // -- Salvar Logs de Erros na tarefas do MySQL (Padrão -> true)
...
define("Server_Location", 0); // -- Localidade de sua Hospedagem [0=USA] [1=BR] (Padrão -> 0)
...
define("Logs_Administrativos", TRUE); // -- Salvar Logs dos game master (Padrão -> true)
...
/*****************************************************************************
	@ Technology Premium Template Settings
	@ Configurações adicionais do template Technology
	@ By: LucasHP - CTM Team Softwares
*****************************************************************************/
define("L_Slide", false); // -- Mostrar slide (rotativo) na página principal (true = Sim / false = Não)
define("L_ImgSlide", "templates/Technology/images/slide/slide.jpg"); // -- Caminho da imagem 01
define("L_LinkSlide", "#linkSlide01"); // -- Link para pagina do slide 01
define("L_ImgSlide2", "templates/Technology/images/slide/slide.jpg"); // -- Caminho da imagem 02
define("L_LinkSlide2", "#linkSlide01"); // -- Link para pagina do slide 02
define("L_ImgSlide3", "templates/Technology/images/slide/slide.jpg"); // -- Caminho da imagem 03
define("L_LinkSlide3", "#linkSlide01"); // -- Link para pagina do slide 03
define("L_ImgSlide4", "templates/Technology/images/slide/slide.jpg"); // -- Caminho da imagem 04
define("L_LinkSlide4", "#linkSlide01"); // -- Link para pagina do slide 04
define("L_ImgSlide5", "templates/Technology/images/slide/slide.jpg"); // -- Caminho da imagem 05
define("L_LinkSlide5", "#linkSlide01"); // -- Link para pagina do slide 05

define("L_Orkut", "#linkOrkut"); // -- Link para a página do servidor no Orkut
define("L_Twitter", "#linkTwitter"); // -- Link para a página do servidor no Twitter
define("L_Facebook", "#linkFacebook"); // -- Link para a página do servidor no Facebook
...
define("NEWFINAL_REF_LINK", "http://muwhite.net/site/?ref="); // -- Link de referência
...
*****************************************************************************/
define("Template_Default", "Technology"); // -- Nome da pasta do Template na pasta "templates" (Template Padrão)
...
/*****************************************************************************
	...
	@ false = Não
*****************************************************************************/
define("Server_Name", "MuWhite"); // -- Nome do Servidor
define("Web_Title", "[Mu] MuWhite - Servidor de MuOnline"); // -- Titulo do Site
define("Server_Version", "97D+99i+Custons"); // -- Versão do Servidor
define("Server_Xp", "1.000x"); // -- Experiência do Servidor
define("Server_Drop", "60%"); // -- Drop do Servidor
...
define("GS_Host", "162.248.244.123"); // -- IP/Host do GameServer (Padrão -> 127.0.0.1);
define("GS_Port", 45321); // -- Porta do GameServer (Padrão -> 55901)
...
/*****************************************************************************
	...
	@ false = Não
*****************************************************************************/
define("Server_List", false); // -- Ativar/Desativar Lista de Servidores
define("CS_Host", "162.248.244.123"); // -- IP do ConnectServer (Padrão -> 127.0.0.1)
define("CS_Port", 56123); // -- Porta do ConnectServer (Padrão -> 44405)
##################################################################
...
$_RaffleSystem["Accounts"] = array("a"); // -- Contas com permisão de gerenciar o sistema (Exemplo: "admin","adm2")
$_RaffleSystem["Raffle"] = array("a"); // -- Contas com permisão para sortear jogadores (Exemplo: "admin","adm2")
$_RaffleSystem["Clear"] = array("a"); // -- Contas com permisão para limpar a lista de sorteados (Exemplo: "admin","adm2")
...
define("Register[VIP][Time]", 30); // -- Tempo de VIP a Ganhar (Padrão -> 5)
define("Register[Cash][Enable]", true); // -- Ganhar Cash ao se Cadastrar (Padrão -> false)
define("Register[Cash][Coin]", 2); // -- Moeda a Ganhar [De 1 a 3] (Padrão -> 1)
define("Register[Cash][Number]", 500); // -- Quantidade de Cash a Ganhar
...
define("Forum_Link", "http://forum.muwhite.net/"); // -- Link do Fórum
...
/*****************************************************************************
	...
	@ false = Não
******************************************************************************/
define("Suportt_Forum", "http://forum.muwhite.net/Index.php?/forum/14-contato-muwhite/"); // -- Link da Ártea de Suporte no Fórum (Caso Tenha Fórum)
define("Suportt_Phone", true); // -- Ativar/Desativar Suporte via telefone
##################################################################
	# E-Mails de Suporte
	# Exemplo: 0 => array("E-Mail", "Atendente"),
##################################################################
$_Suportt["Mail"] = array(0 => array("suporte@muwhite.net", "Admin"),
			   			  1 => array("vendas@muwhite.net", "Suporte a Vendas"),
						  );
##################################################################
...
$_Panel["Account"]["Change_Mail"] = array(0 /* Ativado */,1 /* Free */,1 /* VIP 1 */,1 /* VIP 2 */,1 /* VIP 3 */,1 /* VIP 4 */,1 /* VIP 5 */); // -- Alterar E-Mail
$_Panel["Account"]["Alt_Vault"] = array(0 /* Ativado */,1 /* Free */,1 /* VIP 1 */,1 /* VIP 2 */,1 /* VIP 3 */,1 /* VIP 4 */,1 /* VIP 5 */); // -- Alterar Baú
$_Panel["Account"]["Connects"] = array(1 /* Ativado */,1 /* Free */,1 /* VIP 1 */,1 /* VIP 2 */,1 /* VIP 3 */,1 /* VIP 4 */,1 /* VIP 5 */); // -- Conexões Recentes
$_Panel["Account"]["ScreenShots"] = array(0 /* Ativado */,1 /* Free */,1 /* VIP 1 */,1 /* VIP 2 */,1 /* VIP 3 */,1 /* VIP 4 */,1 /* VIP 5 */); // -- Enviar / Remover ScreenShots
$_Panel["Account"]["ReferenceLink"] = array(1 /* Ativado */,1 /* Free */,1 /* VIP 1 */,1 /* VIP 2 */,1 /* VIP 3 */,1 /* VIP 4 */,1 /* VIP 5 */); // -- Link de Referência
$_Panel["Char"]["Reset"] = array(0 /* Ativado */,1 /* Free */,1 /* VIP 1 */,1 /* VIP 2 */,1 /* VIP 3 */,1 /* VIP 4 */,1 /* VIP 5 */); // -- Reset System
...
$_Panel["Char"]["Trade_RCash"] = array(0 /* Ativado */,1 /* Free */,1 /* VIP 1 */,1 /* VIP 2 */,1 /* VIP 3 */,1 /* VIP 4 */,1 /* VIP 5 */); // -- Trocar Resets por Cash
$_Panel["Char"]["Clear_PK"] =  array(0 /* Ativado */,1 /* Free */,1 /* VIP 1 */,1 /* VIP 2 */,1 /* VIP 3 */,1 /* VIP 4 */,1 /* VIP 5 */); // -- Limpar PK
...
*******************************************************/
$_Panel["Char"]["Reset"]["General"]["Mode"] = 2; // -- Modulo de Reset
...
*******************************************************/
$_Panel["Char"]["MReset"]["Level"] = array(450 /* Free */,400 /* VIP 1 */,350 /* VIP 2 */,280 /* VIP 3 */,280 /* VIP 4 */,280 /* VIP 5*/); // -- Level Minimo
$_Panel["Char"]["MReset"]["Apos"] = array(1 /* Free */,30 /* VIP 1 */,80 /* VIP 2 */,280 /* VIP 3 */,280 /* VIP 4 */,280 /* VIP 5*/); // -- Level Após o Master Reset
$_Panel["Char"]["MReset"]["LimiteMR"] = array(5 /* Free */,6 /* VIP 1 */,7 /* VIP 2 */,280 /* VIP 3 */,280 /* VIP 4 */,280 /* VIP 5*/); // -- Limite de MR
$_Panel["Char"]["MReset"]["Resets"] = array(200 /* Free */,150 /* VIP 1 */,100 /* VIP 2 */,1 /* VIP 3 */,1 /* VIP 4 */,1 /* VIP 5 */); // -- Resets Requeridos
$_Panel["Char"]["MReset"]["Money"] = array(400 /* Free */,350 /* VIP 1 */,280 /* VIP 2 */,280 /* VIP 3 */,280 /* VIP 4 */,280 /* VIP 5 */); // -- Zen Requerido
$_Panel["Char"]["MReset"]["Stats"] = array(32000 /* Free */,32000 /* VIP 1 */,30000 /* VIP 2 */,65000 /* VIP 3 */,65000 /* VIP 4 (Somente DL/LE */); // -- Stats Requeridos para dar o Master Reset
$_Panel["Char"]["MReset"]["Points"] = array(50 /* Força */,200 /* Agilidade */,400 /* Vitalidade */,30 /* Energia */,0 /* Comando (Somente DL/LE */); // -- Stats após o Master Reset
...
$_Panel["Char"]["MReset"]["Cash"] = array(5 /* Free */,8 /* VIP 1 */,15 /* VIP 2 */,4 /* VIP 3 */,5 /* VIP 4 */,6 /* VIP 5 */); // -- Golds a Receber

/************ Configurações do Transferir Resets ************/
$_Panel["Char"]["Transfer_Resets"]["Min_Total"] = 100; // -- Numero minimo de Resets que o char deve conter
...
$_Panel["Char"]["Change_Nick"]["Security"] = array("ADM", "SUB", "MD", "GM", "WebZen", "Web-Zen", "DV", "CL", ); // -- Palavras Bloqueadas (Exemplo: "ADM", "GM")
...
$_Panel["Suportt"]["Tickets"]["Limit_Open"] = 3; // -- Numero maximo de Tickets em Aberto
...
/*****************************************************************************
	...
	@ 3 = Administrador
*****************************************************************************/
$_PanelAdmin["General"]["Master"] = array("a");// -- Contas Admin Master (Exemplo: "admin","adm2")
$_PanelAdmin["ManageX"] = 1; // -- Permissão minima para Gerenciamento Geral
$_PanelAdmin["Mail"] = 4; // -- Enviar E-Mail ao Jogador
$_PanelAdmin["Warning"] = 4; // -- Permissão minima para Gerenciar o Aviso Importante
$_PanelAdmin["News"] = 4; // -- Permissão minima para Gerenciar Noticias
$_PanelAdmin["ScreenShots"] = 4; // -- Permissão minima para Gerenciar ScreenShots (Deletar)
$_PanelAdmin["Downloads"] = 4; // -- Permissão minima para Gerenciar Downloads
$_PanelAdmin["Staff"] = 4; // -- Permissão minima para Gerenciar a Equipe
$_PanelAdmin["Poll"] = 4; // -- Permissão minima para gerenciar Enquetes
...
$_PanelAdmin["Reference"] = 4; // -- Permissão minima para Gerenciar Referência
$_PanelAdmin["Tickets"] = 1; // -- Permissão minima para Gerenciar Tickets de Suporte
$_PanelAdmin["Payments"] = 4; // -- Permissão minima para Gerenciamento de Pagamentos
$_PanelAdmin["VIP"] = 4; // -- Permissão minima para Gerenciar VIP
$_PanelAdmin["Cash"] = 4; // -- Permissão minima para Gerenciar Golds
$_PanelAdmin["SQL"] = 4; // -- Permissão minima para Gerenciar o SQL
$_PanelAdmin["RaffleSystem"] = 4; // -- Permissão minima para Gerenciar o sistema de Sorteio
$_PanelAdmin["AdicionarEventos"] = 1; // -- Permissão minima para Gerenciar Golds
$_PanelAdmin["GerenciarLogs"] = 3; // -- Permissão minima para Gerenciar Logs
...
$_PanelAdmin["Manage"]["EffectWeb"] = array("a"); // -- Contas com permisão de gerenciar Licença da Effect Web (Exemplo: "admin","adm2")

/************ Configurações do Gerenciamento do CronJob ************/
$_PanelAdmin["CronbJob"]["Security"] = array("a"); // -- Contas com permisão de gerenciar o CronJob (Exemplo: "admin","adm2")

/************ Configurações do Gerenciar Contas ************/
$_PanelAdmin["Accounts"]["Manage"] = 4; // -- Permisão minima para Gerenciar Contas
...
$_PanelAdmin["Characters"]["Create"] = 4; // -- Permisão minima para Criar Personagens
$_PanelAdmin["Characters"]["Manage"] = 4; // -- Permisão minima para Editar Personagens
...
$_PanelAdmin["Ticket"]["Delete"] = 4; // -- Permisão minima para deletar Tickets
...
$_PanelAdmin["Payment"]["Delete"] = 4; // -- Permisão minima para deletar Pagamentos

/************ Configurações do Gerenciar VIP ************/
$_PanelAdmin["VIPs"]["All"] = 4; // -- Permisão minima para adicionar VIP em todas as contas Free
...
/*****************************************************************************
	...
	@ false = Não
*****************************************************************************/
define("Show_News", false); // -- Mostrar Notícias (Padrão -> true)
define("Top_News", 7); // -- Total de Notícias (Padrão -> 7)
define("Board_News", false); // -- Mostrar Notícias do Fórum (Padrão -> true)
define("Show_Warning", false); // -- Mostrar Aviso Importante (Padrão -> true)
define("Siege_Enable", false); // -- Mostrar Informações do Castle Siege
define("Siege_Hour", "00:00"); // -- Hora do Castle Siege
define("Top_Resets", false); // -- Mostrar Top Resets/Master Resets (Padrão -> true)
define("Top_RDayRWeekRMonth", false); // -- Mostrar Top Resets Diarios/Semanais/Mensais (Padrão -> true)
define("Top_PKHero", false); // -- Mostrar Top PK/Hero (Padrão -> true)
define("Top_Guilds", false); // -- Mostrar Top Guilds (Padrão -> true)
define("Show_ScreenShots", false); // -- Mostrar ScreenShots Recentes (Padrão -> true)
define("SIEGE_DATE_FIX", false); // -- Habilite esta opção caso o site exibir somado +1 a data do Siege (Padrão -> TRUE)
...
$_Home["Board"]["Link"] = "http://forum.muwhite.net/Index.php?/index"; // -- Link do Fórum
$_Home["Board"]["MySQL"]["Host"] = "localhost"; // -- Host/IP do MySQL (Padrão -> localhost)
$_Home["Board"]["MySQL"]["User"] = "white"; // -- Úsuario do MySQL
$_Home["Board"]["MySQL"]["Pass"] = "taUg38$7"; // -- Senha do MySQL
$_Home["Board"]["MySQL"]["DataBase"] = "muwhite"; // -- DataBase do Fórum (Padrão -> forum)
$_Home["Board"]["Prefix"] = ""; // -- Prefixo das Tables (Padrão -> ibf_)
$_Home["Board"]["Forum_ID"] = array(8,9,11,12); // -- IDs dos Fóruns das Notícias
...
define("Coin_3", "GoldsWhite's"); // -- Nome da Moeda 3
...
define("GL_Column_3", "GoldsWhites"); // -- Coluna de Golds 3 (Padrão -> Point)
...
##################################################################
/****************** VIP 1 *******************/
$_VIP[1] =	array(0 => array(30, 25),
			  	  1 => array(90, 50),
			  	  2 => array(365, 150),
			 	 );
/****************** VIP 2 *******************/
$_VIP[2] =	array(0 => array(30, 50),
			 	  1 => array(90, 100),
			 	  2 => array(365, 250),
			 	 );
