...
<div class="box">
<div class="header">Pagamento {Payment_Post#Date}</div>
	<blockquote>
	<table border="0">
 			 <tr>
	...
	<blockquote>
            ...
            <h4 class="heading colr" style="font-size: 15px;">Dados da Compra</h4>
				 Numero de Cashs: <input type="text" name="Cash" id="Cash" size="7" onFocus="clearText(this)" /><br />
                 Numero de GoldsWhites: <input type="text" name="GoldsW" id="GoldsW" size="7" onFocus="clearText(this)" /><br />
                 Valor do deposito: <input type="text" name="Deposito" id="Deposito" size="7" onFocus="clearText(this)" />
